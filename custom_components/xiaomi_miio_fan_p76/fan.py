...
DEFAULT_RETRIES = 20
DATA_KEY = "fan.xiaomi_miio_fan_p76"
DOMAIN = "xiaomi_miio_fan_p76"
...
AVAILABLE_ATTRIBUTES_FAN_P76 = {
    ...
    "vertical_angle": "vertical_swing_angle",
...
class FanP76(MiotDevice):
    ...
    def set_speed(self, speed: int):
        """Set stepless fan speed (1-100)."""
        if speed < 1 or speed > 100:
            raise FanException("Invalid speed: %s" % speed)
        return self.set_property("fan_speed", speed)

    def set_fan_level(self, level: int):
        """Set gear fan level (0-3)."""
    ...
    def set_vertical_angle(self, angle: int):
        ...
        if angle not in [30, 60, 90, 100]:
            raise FanException(
                "Unsupported vertical angle. Supported values: "
