...
PLATFORM_SCHEMA = PLATFORM_SCHEMA.extend({
    ...
    vol.Optional(CONF_MODEL): vol.In([MODEL_FAN_V1, MODEL_FAN_V2]),
})
...
FAN_SPEED_LIST = [FAN_SPEED_LEVEL1, FAN_SPEED_LEVEL2, FAN_SPEED_LEVEL3, FAN_SPEED_LEVEL4]
...
FEATURE_FLAGS_FAN = (FEATURE_FLAGS_GENERIC | FEATURE_SET_LED | FEATURE_SET_LED_BRIGHTNESS)
...
async def async_setup_platform(hass, config, async_add_devices,
    ...
    if model in [MODEL_FAN_V1, MODEL_FAN_V2]:
